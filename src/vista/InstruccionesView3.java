...
public class InstruccionesView3 extends JFrame {
   ...
   private void establecerTexto() {
        texto = new JLabel("<html>¡OJO! Si no pulsas a tiempo perderas vidas. A medida que el juego avanza el ritmo al que cambian las baldosas es mayor y tu tiempo de reaccion es menor.</html>");
